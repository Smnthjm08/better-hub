...
${pageContextPrompt}`,
    ...
    tools: {
      ...
      searchUsers: tool({
        description:
          "Search GitHub users by username or name.",
        inputSchema: z.object({
      ...
      watchRepo: tool({
        description:
          "Watch/subscribe to a repository for notifications.",
        inputSchema: z.object({
          owner: z.string().describe("Repository owner"),
          repo: z.string().describe("Repository name"),
        }),
      ...
      closeIssue: tool({
        description:
          "Close an issue. Only call after confirmation.",
        inputSchema: z.object({
          owner: z.string().describe("Repository owner"),
          repo: z.string().describe("Repository name"),
      ...
      openRepo: tool({
        description:
          "Navigate to a specific repository within the app.",
        inputSchema: z.object({
          owner: z.string().describe("Repository owner"),
          repo: z.string().describe("Repository name"),
        }),
